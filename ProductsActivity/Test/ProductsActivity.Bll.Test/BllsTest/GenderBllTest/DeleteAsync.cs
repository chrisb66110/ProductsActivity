    ...
    public class DeleteAsyncTest : BaseTest<GenderBll>
    {
        ...
        public async Task DeleteAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IGenderRepository, GenderDto, Exception>(autoMock, m => m.DeleteAsync(It.IsAny<GenderDto>()), responseRepository);
        ...
        public async Task DeleteAsyncDbUpdateConcurrencyExceptionPathDontExist()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IGenderRepository, GenderDto, DbUpdateConcurrencyException>(autoMock, m => m.DeleteAsync(It.IsAny<GenderDto>()), responseRepository);
