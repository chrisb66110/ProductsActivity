    ...
    public class AddAsyncTest : BaseTest<GenderBll>
    {
        ...
        public async Task AddAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IGenderRepository, GenderDto, Exception>(autoMock, m => m.AddAsync(It.IsAny<GenderDto>()), responseRepository);
        ...
        public async Task AddAsyncDbUpdateExceptionPathDuplicate()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IGenderRepository, GenderDto, DbUpdateException>(autoMock, m => m.AddAsync(It.IsAny<GenderDto>()), responseRepository);
