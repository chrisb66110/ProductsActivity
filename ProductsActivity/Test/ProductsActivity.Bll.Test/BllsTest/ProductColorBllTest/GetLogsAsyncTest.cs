...
namespace ProductsActivity.Bll.Test.BllsTest.ProductColorBllTest
{
    ...
    [TestClass]
    public class GetLogsAsyncTest : BaseTest<ProductColorBll>
    {
        [TestMethod]
        public async Task GetLogsAsyncHappyPath()
        {
            ...
            {
                var responseRepository = DataTestHelper.GivenTheDefaultListProductColorLogDto();

                AndIMockDependencyMethod<IProductColorRepository, List<ProductColorLogDto>>(autoMock, m => m.GetLogsAsync(), responseRepository);
        ...
        public async Task GetLogsAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IProductColorRepository, List<ProductColorLogDto>, Exception>(autoMock, m => m.GetLogsAsync(), responseRepository);
