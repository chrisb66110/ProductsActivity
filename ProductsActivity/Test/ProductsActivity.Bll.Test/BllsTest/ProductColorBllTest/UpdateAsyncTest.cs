    ...
    public class UpdateAsyncTest : BaseTest<ProductColorBll>
    {
        ...
        public async Task UpdateAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IProductColorRepository, ProductColorDto, Exception>(autoMock, m => m.UpdateAsync(It.IsAny<ProductColorDto>()), responseRepository);
        ...
        public async Task UpdateAsyncDbUpdateConcurrencyExceptionPathDontExist()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IProductColorRepository, ProductColorDto, DbUpdateConcurrencyException>(autoMock, m => m.UpdateAsync(It.IsAny<ProductColorDto>()), responseRepository);
