...
namespace ProductsActivity.Bll.Test.BllsTest.ProductLikeBllTest
{
    ...
    [TestClass]
    public class AddAsyncTest : BaseTest<ProductLikeBll>
    {
        [TestMethod]
        public async Task AddAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IProductLikeRepository, ProductLikeDto, ProductLikeDto>(autoMock, m => m.AddAsync(It.IsAny<ProductLikeDto>()), responseRepository, param =>
                {
        ...
        public async Task AddAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IProductLikeRepository, ProductLikeDto, Exception>(autoMock, m => m.AddAsync(It.IsAny<ProductLikeDto>()), responseRepository);
        ...
        public async Task AddAsyncDbUpdateExceptionPathDuplicate()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IProductLikeRepository, ProductLikeDto, DbUpdateException>(autoMock, m => m.AddAsync(It.IsAny<ProductLikeDto>()), responseRepository);
