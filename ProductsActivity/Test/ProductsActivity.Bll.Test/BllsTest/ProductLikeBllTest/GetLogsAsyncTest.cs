...
namespace ProductsActivity.Bll.Test.BllsTest.ProductLikeBllTest
{
    ...
    [TestClass]
    public class GetLogsAsyncTest : BaseTest<ProductLikeBll>
    {
        [TestMethod]
        ...
        public async Task GetLogsAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IProductLikeRepository, List<ProductLikeLogDto>, Exception>(autoMock, m => m.GetLogsAsync(), responseRepository);
