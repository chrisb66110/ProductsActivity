    ...
    public class UpdateAsyncTest : BaseTest<AgeGroupBll>
    {
        ...
        public async Task UpdateAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IAgeGroupRepository, AgeGroupDto, Exception>(autoMock, m => m.UpdateAsync(It.IsAny<AgeGroupDto>()), responseRepository);
        ...
        public async Task UpdateAsyncDbUpdateConcurrencyExceptionPathDontExist()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IAgeGroupRepository, AgeGroupDto, DbUpdateConcurrencyException>(autoMock, m => m.UpdateAsync(It.IsAny<AgeGroupDto>()), responseRepository);
