    ...
    public class AddAsyncTest : BaseTest<ColorBll>
    {
        ...
        public async Task AddAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IColorRepository, ColorDto, Exception>(autoMock, m => m.AddAsync(It.IsAny<ColorDto>()), responseRepository);
        ...
        public async Task AddAsyncDbUpdateExceptionPathDuplicate()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IColorRepository, ColorDto, DbUpdateException>(autoMock, m => m.AddAsync(It.IsAny<ColorDto>()), responseRepository);
