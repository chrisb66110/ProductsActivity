    ...
    public class DeleteAsyncTest : BaseTest<SizeBll>
    {
        ...
        public async Task DeleteAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<ISizeRepository, SizeDto, Exception>(autoMock, m => m.DeleteAsync(It.IsAny<SizeDto>()), responseRepository);
        ...
        public async Task DeleteAsyncDbUpdateConcurrencyExceptionPathDontExist()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<ISizeRepository, SizeDto, DbUpdateConcurrencyException>(autoMock, m => m.DeleteAsync(It.IsAny<SizeDto>()), responseRepository);
