    ...
    public class DeleteAsyncTest : BaseTest<CategoryBll>
    {
        ...
        public async Task DeleteAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<ICategoryRepository, CategoryDto, Exception>(autoMock, m => m.DeleteAsync(It.IsAny<CategoryDto>()), responseRepository);
        ...
        public async Task DeleteAsyncDbUpdateConcurrencyExceptionPathDontExist()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<ICategoryRepository, CategoryDto, DbUpdateConcurrencyException>(autoMock, m => m.DeleteAsync(It.IsAny<CategoryDto>()), responseRepository);
