...
namespace ProductsActivity.Bll.Test.BllsTest.CategoryBllTest
{
    ...
    [TestClass]
    public class GetByIdAsyncTest : BaseTest<CategoryBll>
    {
        [TestMethod]
        public async Task GetByIdAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<ICategoryRepository, long, CategoryDto>(autoMock, m => m.GetByIdAsync(It.IsAny<long>()), responseRepository, param =>
                {
        ...
        public async Task GetByIdAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                var idRequest = DataTestHelper.GivenTheDefaultCategoryDto().Id;
                AndIMockDependencyMethod<ICategoryRepository, CategoryDto, Exception>(autoMock, m => m.GetByIdAsync(It.IsAny<long>()), responseRepository);
