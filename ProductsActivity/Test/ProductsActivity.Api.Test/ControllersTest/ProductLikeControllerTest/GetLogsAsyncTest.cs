...
namespace ProductsActivity.Api.Test.ControllersTest.ProductLikeControllerTest
{
    ...
    [TestClass]
    public class GetLogsAsyncTest : BaseTest<ProductLikeController>
    {
        [TestMethod]
        public async Task GetLogsAsyncHappyPath()
        {
            ...
            {
                var responseBll = DataTestHelper.GivenTheDefaultListProductLikeLogDto();
                AndIMockDependencyMethod<IProductLikeBll, List<ProductLikeLogDto>>(autoMock, m => m.GetLogsAsync(), responseBll);
                ...
                var responseObject = (List<ProductLikeLogResponse>)response.Value;
        ...
        public async Task GetLogsAsyncNoContentPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                var responseBll = new List<ProductLikeLogDto>();
                AndIMockDependencyMethod<IProductLikeBll, List<ProductLikeLogDto>>(autoMock, m => m.GetLogsAsync(), responseBll);
        ...
        public async Task GetLogsAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IProductLikeBll, List<ProductLikeLogDto>, Exception>(autoMock, m => m.GetLogsAsync(), exception);
