...
namespace ProductsActivity.Api.Test.ControllersTest.ImageLikeControllerTest
{
    ...
    [TestClass]
    public class GetLogsAsyncTest : BaseTest<ImageLikeController>
    {
        [TestMethod]
        public async Task GetLogsAsyncHappyPath()
        {
            ...
            {
                var responseBll = DataTestHelper.GivenTheDefaultListImageLikeLogDto();
                AndIMockDependencyMethod<IImageLikeBll, List<ImageLikeLogDto>>(autoMock, m => m.GetLogsAsync(), responseBll);
                ...
                var responseObject = (List<ImageLikeLogResponse>)response.Value;
        ...
        public async Task GetLogsAsyncNoContentPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                var responseBll = new List<ImageLikeLogDto>();
                AndIMockDependencyMethod<IImageLikeBll, List<ImageLikeLogDto>>(autoMock, m => m.GetLogsAsync(), responseBll);
        ...
        public async Task GetLogsAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IImageLikeBll, List<ImageLikeLogDto>, Exception>(autoMock, m => m.GetLogsAsync(), exception);
