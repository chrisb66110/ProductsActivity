...
namespace ProductsActivity.Dal.Test.RepositoriesTest.ProductLikeRepositoryTest
{
    ...
    [TestClass]
    public class DeleteAsyncTest : BaseRepositoryTest<ProductLikeRepository, ProductsActivityContext>
    {
        [TestMethod]
        public async Task DeleteAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                var deletedDto = DataTestHelper.GivenTheDefaultListProductLikeDto().First();
