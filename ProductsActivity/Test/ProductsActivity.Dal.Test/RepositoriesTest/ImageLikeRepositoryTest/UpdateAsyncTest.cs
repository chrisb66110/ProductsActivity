...
namespace ProductsActivity.Dal.Test.RepositoriesTest.ImageLikeRepositoryTest
{
    ...
    [TestClass]
    public class UpdateAsyncTest : BaseRepositoryTest<ImageLikeRepository, ProductsActivityContext>
    {
        [TestMethod]
        public async Task UpdateAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                var updatedDto = DataTestHelper.GivenTheDefaultListImageLikeDto().First();
