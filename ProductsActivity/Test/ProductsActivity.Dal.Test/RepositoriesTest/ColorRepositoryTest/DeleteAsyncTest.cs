...
namespace ProductsActivity.Dal.Test.RepositoriesTest.ColorRepositoryTest
{
    ...
    [TestClass]
    public class DeleteAsyncTest : BaseRepositoryTest<ColorRepository, ProductsActivityContext>
    {
        [TestMethod]
        public async Task DeleteAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                var deletedDto = DataTestHelper.GivenTheDefaultListColorDto().First();
