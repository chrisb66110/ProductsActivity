...
namespace ProductsActivity.Dal.Test.RepositoriesTest.ColorRepositoryTest
{
    ...
    [TestClass]
    public class UpdateAsyncTest : BaseRepositoryTest<ColorRepository, ProductsActivityContext>
    {
        [TestMethod]
        public async Task UpdateAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                updatedDto.Name = updatedProperty;

                entities.First(e => e.Id == updatedDto.Id).Name = updatedProperty;
